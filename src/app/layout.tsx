...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: 'https://bestseatosky.com/og-default.jpg',
        width: 1200,
        height: 630,
        alt: 'Best Sea to Sky — Your local guide to Squamish, Whistler & Pemberton',
      },
    ],
  },
  twitter: {
    ...
    description:
      'Discover the best restaurants, hotels, adventures, and attractions across the Sea to Sky corridor.',
    images: ['https://bestseatosky.com/og-default.jpg'],
  },
};
